...
rtypeBlog::load('controller/RTypeBlogController.php');



class RTypeBlogView extends View
{
  ...
  public function __construct( $defResCtrl = null ){
    ...
    $this->rTypeCtrl = new RTypeBlogController( $defResCtrl );
  }
  ...
  public function getFormBlock( $formName, $urlAction, $valuesArray = false ) {
    // error_log( "RTypeBlogView: getFormBlock()" );
  ...
  public function actionResourceForm() {
    // error_log( "RTypeBlogView: actionResourceForm()" );
