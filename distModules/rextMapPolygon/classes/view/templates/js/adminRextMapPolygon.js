...
geozzy.adminRextMapPolygonView  = Backbone.View.extend({
  ...
  render: function() {
    ...
    that.parent.$el.find( '.resourceLocationFrame .locationDialog .polygonFormMap .btnClearLastPolygon').on('click', function(){
      that.clearLastCorner();
    });
