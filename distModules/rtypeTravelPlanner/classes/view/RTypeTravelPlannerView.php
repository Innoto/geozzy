...
rtypeTravelPlanner::load('controller/RTypeTravelPlannerController.php');



class RTypeTravelPlannerView extends View
{
  ...
  public function __construct( $defResCtrl = null ){
    ...
    $this->rTypeCtrl = new RTypeTravelPlannerController( $defResCtrl );
  }
  ...
  public function getFormBlock( $formName, $urlAction, $valuesArray = false ) {
    // error_log( "RTypeTravelPlannerView: getFormBlock()" );
  ...
  public function actionResourceForm() {
    // error_log( "RTypeTravelPlannerView: actionResourceForm()" );
