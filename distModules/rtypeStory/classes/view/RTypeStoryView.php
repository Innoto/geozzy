...
rtypeStory::load('controller/RTypeStoryController.php');



class RTypeStoryView extends View
{
  ...
  public function __construct( $defResCtrl = null ){
    ...
    $this->rTypeCtrl = new RTypeStoryController( $defResCtrl );
  }
  ...
  public function getFormBlock( $formName, $urlAction, $valuesArray = false ) {
    // error_log( "RTypeStoryView: getFormBlock()" );
  ...
  public function actionResourceForm() {
    // error_log( "RTypeStoryView: actionResourceForm()" );
