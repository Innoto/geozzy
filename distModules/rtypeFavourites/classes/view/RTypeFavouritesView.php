...
rtypeFavourites::load('controller/RTypeFavouritesController.php');



class RTypeFavouritesView extends View
{
  ...
  public function __construct( $defResCtrl = null ){
    ...
    $this->rTypeCtrl = new RTypeFavouritesController( $defResCtrl );
  }
  ...
  public function getFormBlock( $formName, $urlAction, $valuesArray = false ) {
    // error_log( "RTypeFavouritesView: getFormBlock()" );
  ...
  public function actionResourceForm() {
    // error_log( "RTypeFavouritesView: actionResourceForm()" );
