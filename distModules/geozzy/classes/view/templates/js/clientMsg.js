...
geozzy.clientMsgClass = function( options ) {
  ...
  that.confirm = function( msg, fnResult, fnOptions ) {
    ...
    // geozzy.clientMsg.confirm('OKI', function(val){ console.log('fnResult:', val); } );
  ...
  that.prompt = function( msg, fnResult, fnOptions ) {
    ...
    // geozzy.clientMsg.prompt( 'OKI', function(val){ console.log('fnResult:', val); } );
