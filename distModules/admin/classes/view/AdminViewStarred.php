...
class AdminViewStarred extends AdminViewMaster
{
  ...
  **/
  public function listAssignStarred( $urlParams ) {
    ...
    $panel = $this->getPanelBlock( '<ul style="list-style:none;"><li>'. __("Create a new resource") .'</li><li>'. __("Working with resource types") .'</li><li>'. __("Assign to this starred") .'</li></ul>'. __('Assign resources: howto') );
