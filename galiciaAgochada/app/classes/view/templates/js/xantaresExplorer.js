  ...
  $(document).ready(function(){
    ...
    explorador.createInterfaceFilterContainers();
  ...
  paisaxesExplorer = function() {
    ...
    that.setFilters = function() {
      ...
      $(that.explorerclass+' .explorer-container-map').append(filterMap);
    ...
    that.exec = function(){
      ...
      $('select.select2GeozzyCustom').select2({
         ...
         templateSelection: that.formatState,
     ...
     */
    that.createInterfaceFilterContainers = function(){
