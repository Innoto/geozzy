...
/*
  ...
  array(
    ...
    'name' => array(
      'en' => 'Use CCCCCC tpl',
      'es' => 'Usamos el tpl CCCCCC',
      'gl' => 'Usamos o tpl CCCCCC'
    )
  )
  ...
  array(
    ...
    'view' => 'RExtViewAltAppCCCCCC',
    'module' => 'rextView', // No indicar o false para
    // Class: RExtViewAltAppCCCCCC, File: RExtViewAltAppCCCCCC.php
    // Recomend tpl file name: rExtViewAltAppCCCCCC.tpl
    'name' => array(
      'en' => 'Use CCCCCC class',
...
$rExtViewAppInitialTerms = array(
  array(
    ...
    // tpl file name: rExtViewAltAppHome.tpl
    'name' => array(
      'en' => 'Use Home',
      'es' => 'Usar Portada',
      'gl' => 'Usar Portada'
  ...
  array(
    ...
    // tpl file name: rExtViewAltAppXantaresExplorer.tpl
    'name' => array(
  ...
  array(
    ...
    // tpl file name: rExtViewAltAppAloxamentosExplorer.tpl
    'name' => array(
  ...
  array(
    ...
    // tpl file name: rExtViewAltAppRinconsExplorer.tpl
    'name' => array(
  ...
  array(
    ...
    // tpl file name: rExtViewAltAppPraiasExplorer.tpl
    'name' => array(
  ...
  array(
    ...
    // tpl file name: rExtViewAltAppPaisaxesExplorer.tpl
    'name' => array(
  ...
  array(
    ...
    // tpl file name: rExtViewAltAppTodosSegredosExplorer.tpl
    'name' => array(
