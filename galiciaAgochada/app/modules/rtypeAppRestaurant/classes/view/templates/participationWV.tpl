...
<div id="participation-step2" class="participation-step2" data-resource="10">
  <div class="container">
    ...
    <div class="subStep subStep1">
      ...
      <div class="subStepActions">
        <div class="row">
          <div class="col-xs-6">
            <button type="button" class="btn btn-warning cancel hidden-sm hidden-xs" aria-label="Close">{t}Cancelar{/t}</button>
          </div>
          <div class="col-xs-6">
  ...
  <script type="text/javascript">
    $(document).ready(function(){
      ...
      $('.participation-step2 .subStepActions .cancel').on('click', function (e) {
        GeozzyMobileApp.resultParticipation(false);
      });
      ...
      var customSelectTypeHtml = '<div class="customEatanddrinkType"><div class="row row-eq-height">';
