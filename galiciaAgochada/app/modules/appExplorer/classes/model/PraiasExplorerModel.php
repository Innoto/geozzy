...
class PraiasExplorerModel extends Model
{
  ...
  static $tableName = 'geozzy_praias_explorer_index';
  static $cols = array(
    'id' => array(
      'type' => 'INT',
      'primarykey' => true
  ...
  static $extraFilters = array(
    'ids' => ' id IN (?)',
    'updatedfrom' => ' ( geozzy_praias_explorer_index.timeCreation >= ? OR geozzy_praias_explorer_index.timeLastUpdate >= ? ) '
