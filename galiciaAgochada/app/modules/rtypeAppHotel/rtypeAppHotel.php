...
class rtypeAppHotel extends Module {
  ...
  public $version = '1.0';
  public $rext = array( 'rextAccommodation', 'rextContact', 'rextSocialNetwork', 'rextAppZona',
    'rextBI', 'rextMap', 'rextMapDirections', 'rextComment', 'rextReccommended', 'rextFavourite',
