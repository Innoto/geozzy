...
$conf->setSetupValue( 'mail', array(
  ...
  'port' => '587',
  'auth' => true,
  'user' => 'info@becas.faortega.org',
  'pass' => 'bachi11er',
  'secure' => 'tls',
  'fromName' => 'Nice2MeetYou | BECARIOS FUNDACIÓN AMANCIO ORTEGA',
  'fromEmail' => 'info@becas.faortega.org'
));
...
// Google keys
//
$conf->setSetupValue( 'google:maps:key', 'AIzaSyDkNx9IA9093KtrCRMVwUfgRi7vp_A_npQ' );
// $conf->setSetupValue( 'google:recaptcha:key:site', '6LcEeQwTAAAAABvylWDu4npaLmHoavDXX-PTJAJT' );
// $conf->setSetupValue( 'google:recaptcha:key:secret', '6LcEeQwTAAAAAKGvHVRz1Nug5jTfHTP9Ub2yUK-d' );
//
...
$conf->setSetupValue( 'socialNetworks', [
  'facebook' => 'becasfaortega',
  'twitter' => 'BecasFaortega'
]);
...
// Admin.
//
$conf->setSetupValue( 'mod:admin:titlePath', 'Becarios Admin' );
$conf->setSetupValue( 'mod:admin:logoPath', '/img/logo.png' );

//
// Convocatoria
//
$conf->setSetupValue( 'becarios:convocatoria', '2017' );
...
//USER PROFILE
$conf->setSetupValue( 'mod:geozzyUser', [
  'profile' => '',
  'recoveryPasswordRedirect' => '/nice2meetyou'
]);
...
$conf->setSetupValue( 'mod:geozzy:resource:commentRules',
  array(
    ...
    'rtypeAppBlog' => array(
      ...
      'anonymous' => false,
      'ctype' => array('comment'), // 'comment','suggest'
      'commentRate' => false
    )
  )
);
...
$conf->setSetupValue( 'mod:geozzy:resource:urlAliasPatterns', [
  ...
  'rtypeAppBecario' => [ 'default' => '/nice2meetyou/becarios/' ],
  'rtypeAppBlog' => [ 'default' => '/nice2meetyou/blog/' ],
  'rtypeAppAviso' => [ 'default' => '/INTERNO_Aviso/' ],
]);
