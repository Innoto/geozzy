...
// DateTimeZone
//
cogumeloSetSetupValue( 'date:timezone:system', 'UTC' );
cogumeloSetSetupValue( 'date:timezone:database', 'UTC' );
cogumeloSetSetupValue( 'date:timezone:project', 'Europe/Madrid' );
